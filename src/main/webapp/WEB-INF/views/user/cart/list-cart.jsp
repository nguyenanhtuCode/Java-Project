		...
		<div class="span12">
			<ul class="breadcrumb">
				<li><a href="javascript:void(0);"
					onclick="window.location.href='/DiamonShop/trang-chu';">Trang chủ</a> <span class="divider">/</span></li>
				<li class="active">Giỏ hàng</li>
			</ul>
			<div class="well well-small">
				<h1>
					Giỏ hàng <small class="pull-right"> ${ TotalQuantityCart }
				...
				<br /> <a href="javascript:void(0);" class="shopBtn btn-large"
					onclick="window.location.href='/DiamonShop/trang-chu';"> <span class="icon-arrow-left"></span>
					Tiếp tục mua sắm
				</a>
				<form
					onsubmit="event.preventDefault(); window.location.href='/DiamonShop/checkout';"
					class="pull-right" style="display: inline;">
					<button type="submit" class="shopBtn btn-large">
